...
public class SiftPresenter implements ISiftPresenter {
    private ISiftFragment iSiftFragment;
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {      //判断标志位
                case 1:
                    ...
                    loadSiftTeaseList(teaseSpecifics);
                    break;
            }
        }
    };

    public SiftPresenter(ISiftFragment iSiftFragment){
        this.iSiftFragment = iSiftFragment;
    }


    @Override
    public void query_Tease(Boolean isSift) {
        final BmobQuery<Tease> query = new BmobQuery<Tease>();
        query.addWhereEqualTo("isSift",isSift);
     ...
     */
    private void loadSiftTeaseList(List<TeaseSpecific> teaseSpecifics){
        iSiftFragment.loadSiftTeaseList(teaseSpecifics);
    }
}
