...
public class TeaseAdapter extends RecyclerView.Adapter {
    private RecyclerView recyclerView;
    private List<TeaseSpecific> teaseList = new ArrayList<>();
    private Context context;

    public TeaseAdapter(RecyclerView recyclerView, Context context){
    ...
    public class TeaseItemViewHolder extends RecyclerView.ViewHolder {
        ...
        private void init(View view){
            ...
            item_tease_praise_sb.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    int like = tease.getPraise().intValue();
                    if (item_tease_praise_sb.isChecked()) {
                        like++;
                    } else {
                        like--;
                    }
                    //((TeaseFragment)context).like(tease.getTease());
                    item_tease_comment_num.setText(like);
                }
            });
        }
